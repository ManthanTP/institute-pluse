...
import { BookOpen, Upload, Search, FileText, Video, Link2, Trash2, Plus, X, ExternalLink, Clock, User, FolderOpen } from 'lucide-react'
...
const CATEGORIES = [
  { id: 'All', label: 'All', icon: FolderOpen, color: '#ef4444' },
...
export default function AdminResourceHubPage() {
  ...
  const getCategoryColor = (type) => CATEGORIES.find(c => c.id === type)?.color || '#ef4444'
    ...
    <AdminLayout>
      <div className="space-y-6 lg:space-y-8 pb-20 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-xl lg:text-2xl font-black text-white uppercase tracking-tighter">Resource Management</h2>
            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mt-1">Audit and share study materials</p>
          </div>
          <button
            onClick={() => setShowUpload(true)}
            className="px-6 py-3.5 bg-red-600 text-white rounded-xl text-[9px] font-black uppercase tracking-widest shadow-lg shadow-red-600/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center gap-2"
          >
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-[#161b22] border border-white/10 rounded-xl py-3.5 pl-11 pr-4 text-sm text-white focus:outline-none focus:border-red-500 transition-all placeholder:text-gray-600"
            />
          </div>
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:border-red-500 transition-all placeholder:text-gray-600"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full bg-[#161b22] border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:border-red-500 transition-all appearance-none"
                    >
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:border-red-500 transition-all placeholder:text-gray-600 resize-none"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div
                    ...
                    className={`w-full py-6 border-2 border-dashed border-white/10 rounded-xl flex flex-col items-center gap-2 cursor-pointer hover:border-red-500/30 hover:bg-red-500/5 transition-all ${
                      selectedFile ? 'border-red-500 bg-red-500/5' : ''
                    }`}
                  >
                    <Upload size={20} className={selectedFile ? 'text-red-500' : 'text-gray-500'} />
                ...
                <button
                  ...
                  disabled={uploading}
                  className="w-full py-4 bg-red-600 text-white rounded-xl text-[9px] font-black uppercase tracking-widest shadow-lg shadow-red-600/20 hover:bg-red-500 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {uploading ? (
