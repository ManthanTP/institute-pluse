...
export default function FacultySustainabilityPage() {
  ...
  useEffect(() => {
    const channel = supabase
      .channel('faculty_sustainability_realtime')
  ...
  const handleGenerateReport = () => {
    exportReportPDF({
      ...
      studentName: 'Faculty Sustainability Auditor',
      theme: 'cyber'
    })
      ...
      <div className="space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-black text-blue-500 uppercase tracking-[0.3em]">Campus Carbon Offset Index</span>
            </div>
          ...
          <div className="flex gap-3">
             <button 
               ...
               className="px-6 py-3 rounded-2xl bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest hover:text-white transition-all text-blue-500 border-blue-500/20"
             >
                Generate Report
             </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
           {[
             ...
             { label: 'Ecosystem Nodes', value: stats.activeUsers, icon: Zap, color: 'text-indigo-500', bg: 'bg-indigo-500/10' },
             { label: 'Efficiency Index', value: `${stats.avgEfficiency}%`, icon: Target, color: 'text-teal-500', bg: 'bg-teal-500/10' },
           ].map((s, i) => (
             <motion.div 
               key={s.label}
           ...
           <div className="grid grid-cols-1 gap-4 lg:hidden">
              {loading ? (
                ...
                <div 
                  ...
                  className="bg-white/5 border border-white/10 rounded-[28px] p-6 backdrop-blur-xl cursor-pointer hover:border-blue-500/30 transition-all"
                >
